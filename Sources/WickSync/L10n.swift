...
public enum L10n {
    ...
    public enum Key {
        ...
        public var chinese: String {
            ...
            case .exchangeReadonlyHint: return "请使用只有读取权限的 API Key。"
            ...
            case .exchangePositionSize: return "数量 · 持有"
        ...
        public var english: String {
            ...
            case .exchangeReadonlyHint: return "Please use an API key with read-only permissions."
            ...
            case .exchangePositionSize: return "Size · Duration"
