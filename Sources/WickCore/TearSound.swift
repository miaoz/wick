...
/// are the small protests the paper makes while you pull. Generated on demand via
/// `AVAudioEngine`, so nothing needs to ship in the bundle.
@MainActor
final class TearSound {
    ...
    private static func renderRip(in format: AVAudioFormat) -> AVAudioPCMBuffer {
        ...
        while t < n - 64 {
            ...
            let swell = 0.45 + 0.75 * sinf(prog * .pi)
