...
/// Item source for the macOS 13 journal toolbar: sidebar toggle leftmost
/// (responder-chain `toggleSidebar:`, same as the system item — traffic-light
/// row, leading edge, present whether the sidebar is expanded or collapsed),
/// journal-library menu next to it, new-entry at the trailing edge.
///
