...
(function () {
  ...
  var I18N_EN = {
    ...
    "feat4.p": "Read-only links to exchanges like Binance, OKX and Hyperliquid. Fills aggregate into positions pinned to the day's page. Keys never leave this machine.",
    ...
    "dl.pitch.desc": "Review today's trades today, trade tomorrow's setups tomorrow. Bring time progress, macro events, and trade history to your desktop.",
    "dl.meta": "macOS 13 Ventura or later (Universal) · Linux (Arch / Ubuntu / Fedora · x86_64)",
